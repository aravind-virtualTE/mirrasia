      ...
      <CardContent className="p-8">
        ...
        <ResolutionSection number="1" title="Incorporation">
          ...
          <ul className="list-none space-y-2">
            <li>(i) the Company was incorporated on <span><input className='underline' type="text" value={resolutionDetails.inCorporatedDate} onChange={(e) => setResolutionDetails({...resolutionDetails, inCorporatedDate : e.target.value})} /></span></li>
            <li>(ii) the registration number assigned to the Company is <span><input  className='underline' type="text" value={resolutionDetails.regNumber} onChange={(e) => setResolutionDetails({...resolutionDetails, regNumber : e.target.value})} /></span>;</li>
        ...
        <ResolutionSection number="4" title="Registered Office">
          <p className="mb-2">
            Noted that the intended registered office address of <span className="underline px-1">{data.address.full}</span> stated 
        ...
        <ResolutionSection number="5" title="Registers and Minute books">
          <p className="mb-2">
            ...
            Company be kept at <span className="underline px-1">{data.address.full}</span> until otherwise determined
