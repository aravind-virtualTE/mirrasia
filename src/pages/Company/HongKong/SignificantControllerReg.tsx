      ...
      <Card className="w-full max-w-[1200px] mx-auto p-6 print:p-0">
        ...
        <CardContent className="space-y-8">
          <div>
            ...
            <Table className="border">
              <TableHeader>
                <TableRow>
                  <TableHead className="border font-bold">Entry No.</TableHead>
                  <TableHead className="border font-bold">Date of entry</TableHead>
                  <TableHead className="border font-bold">
                    Name of registrable person /<br />
                    legal entity
                  </TableHead>
                  <TableHead className="border font-bold">Particulars</TableHead>
                  <TableHead className="border font-bold">Remarks / Notes</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
            ...
            <Table className="border">
              <TableHeader>
                <TableRow>
                  <TableHead className="border font-bold">Entry No.</TableHead>
                  <TableHead className="border font-bold">Date of entry</TableHead>
                  <TableHead className="border font-bold">Name (Capacity)</TableHead>
                  <TableHead className="border font-bold">Particulars</TableHead>
                  <TableHead className="border font-bold">Remarks / Notes</TableHead>
                </TableRow>
              </TableHeader>
        ...
        <CardFooter className="flex flex-col items-end mt-6 space-y-6">
          <div className="text-right space-y-4">
            ...
            <div className="border-2 border-red-500 w-48 h-24 mt-4" />
