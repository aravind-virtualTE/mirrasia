  ...
  return (
    <Card className="max-w-4xl mx-auto p-8 rounded-none shadow-none font-serif">
      <CardHeader className="space-y-4 p-0">
        <div className="space-y-2">
          ...
          <div className="space-y-4  text-base">
            ...
            <div className="ml-[4rem] font-medium">
      ...
      <CardContent className="space-y-6 p-0 pt-4">
        <p>
          We/I, <span className="">AHMED, SHAHAD</span>, the undersigned, hereby inform you that I do have significant control over the Company and confirm the following particulars are true and correct:
        </p>
        ...
        <div className="space-y-4">
          <div className="grid gap-y-2">
            <div className="flex gap-x-2">
              <span>1</span>
              <span>Full Name :</span>
              <span className="">AHMED, SHAHAD</span>
            </div>
            <div className="flex gap-x-2">
              <span>2</span>
            ...
            <div className="flex gap-x-2">
              ...
              <span className="">144706613 (UNITED KINGDOM)</span>
            </div>
            <div className="flex gap-x-2">
              <span>5</span>
            ...
            <div className="flex gap-x-2">
              ...
              <span className="">Holds {'    '}100%{'    '} of the issued shares of the company directly.</span>
            </div>
          </div>
        </div>       
