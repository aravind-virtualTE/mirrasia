                    ...
                    <Card>
                        <CardHeader className="pb-2">
                            <div className="flex items-start gap-3">
                                ...
                                {/*please maintain same name variable as in data foundationNameEn as name 1 please avoid, please show the foundationNameEs as spanish name when it is not empty  */}
                        ...
                        <CardContent className="grid gap-5">
                            ...
                            {/* <div className="grid gap-3">
                                ...
                                <div className="grid md:grid-cols-3 gap-4">
                                    <LabelValue label="Need">{(data as any)?.bankingNeed || "—"}</LabelValue>
                                    <LabelValue label="Business Type">{(data as any)?.bankingBizType || "—"}</LabelValue>
                                </div>
                            </div> */}
                            {/* --- I. Banking --- */}
                            <div className="grid gap-3">
                                ...
                                <div className="rounded-md border p-3 grid gap-3">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-4">
                                        ...
                                        {/* Compact guidance chip mirrors the selection in the other component */}
                                        {/* <LabelValue label="Guidance">
                                            {(() => {
                                                const need = (data as any)?.bankingNeed;
                                                const biz = (data as any)?.bankingBizType;
                                                if (need === "need") {
                                                    if (biz === "crypto") return "Enhanced KYC expected for virtual-asset activities.";
                                                    if (biz === "investment") return "Be ready with proof of source of funds & portfolio docs.";
                                                    if (biz === "ecommerce") return "Expect merchant statements or platform screenshots if any.";
                                                    if (biz === "manufacturing") return "Trade invoices & supplier/customer details help.";
                                                    return "Standard KYC; company docs and ID/address proofs.";
                                                }
                                                if (need === "later") return "We’ll revisit this during onboarding.";
                                                if (need === "none") return "No banking requested at this time.";
                                                return "—";
                                            })()}
                                        </LabelValue> */}
                                    </div>
