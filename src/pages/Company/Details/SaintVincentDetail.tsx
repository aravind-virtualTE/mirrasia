...
const COUNTRY_CODE = "VC";
const COUNTRY_LABEL = "Saint Vincent and the Grenadines";
...
/** ---------------- component ---------------- */
const SaintVincentDetail: React.FC<{ id: string }> = ({ id }) => {
...
export default SaintVincentDetail;
