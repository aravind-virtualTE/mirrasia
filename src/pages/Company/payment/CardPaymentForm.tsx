...
import {useStripe, useElements,Elements, CardNumberElement, CardExpiryElement, CardCvcElement
    ...
    try {
      ...
      const { error: stripeError, paymentIntent } = await stripe.confirmCardPayment(
        ...
        payment_method: {
          ...
          billing_details: {
            ...
            email: values.email,
            address: {
              country: values.country, // This is now the 2-letter country code
      ...
      if (stripeError) {
        ...
        if (paymentIntent.status === 'succeeded') {
          ...
          const sessionData = await paymentApi.updateFinalPaymentStatus(sessionId, paymentId, docId!, paymentIntent, "HK");
