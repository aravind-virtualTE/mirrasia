...
import { SgBankTransferMethod } from "./SgBkTransferMethod";
import { SgStripePaymentForm } from "./SgStripe";
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        {method === 'card' && <SgStripePaymentForm sessionId={sessionId} clientSecret={clientSecret} amount={amount} />}
        {method === 'bank' && <SgBankTransferMethod sessionId={sessionId} />}
        {/* {method === 'fps' && <FPSForm />} */}
        {method === 'other' && <SgReceiptUpload sessionId={sessionId} />}
      </DialogContent>
    </Dialog>
  )
};

export default function SgPaymentMethods({ sessionId, amount, id }: PaymentMethodProps) {
