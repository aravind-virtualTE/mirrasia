                    ...
                    <Card>
                        <CardContent className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-800">In the case of issuing preference shares or corporate bonds, pre-advice may be required before proceeding, such as reviewing articles of associations and legal regulations.</p>
                                <RadioGroup className="mt-4 space-y-3"
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-800">It is recommended that the currency of the share capital be the same as the functional currency to be used for accounting purposes. For example, if you trade both purchases and sales in USD, setting the share capital in USD is convenient for accounting. If this is not the case, all currencies of translations must be converted to the base currency for accounting. Please note that the currency of the share capital cannot be changed to another currency after the incorporation.  (Example: Share Capital issued in HKD cannot be changed to USD)</p>
                                <RadioGroup className="mt-4 space-y-3"
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-800">This is the amount according to the above base currency. Example) USD 1,000</p>
                                <RadioGroup className="mt-4 space-y-3"
