    ...
    return (
        <div className="flex w-full p-4">
            <aside className="w-1/4 bg-blue-50 p-4 rounded-md shadow-sm">
                <h2 className="text-lg font-semibold mb-2">Shareholders/directors of the Hong Kong company</h2>
                <p className="text-sm text-gray-600">Please provide information on the shareholders, directors, significant controllers, and designated contact persons of the Hong Kong company.</p>
            </aside>
            <div className="w-3/4 ml-4">
                <Card>
                    <CardContent className="space-y-6">
                        <div>
                            <Label className="text-base font-semibold">Total number of shareholders <span className="text-red-500 font-bold ml-1">*</span></Label>
                        ...
                        <div>
                            <Label className="text-base font-semibold">Total number of directors <span className="text-red-500 font-bold ml-1">*</span></Label>
                            <RadioGroup className="mt-4 space-y-3"
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-800">Example) 1. Jack: Shareholder/Director/Number of shares assigned: 1,000,  2. John: Not Shareholder/Directors,  3. William: Shareholder/Not Director/Number of shares assigned: 800</p>
                            <Input
