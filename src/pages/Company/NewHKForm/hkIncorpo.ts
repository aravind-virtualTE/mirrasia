...
export const applicantRoles = [
  {
    label: "newHk.steps.applicant.fields.roles.options.Director",
    value: "Director",
  },
  {
    label: "newHk.steps.applicant.fields.roles.options.Shareholder",
    value: "Shareholder",
  },
  {
    label: "newHk.steps.applicant.fields.roles.options.Authorized",
    value: "Authorized",
  },
  {
    label: "newHk.steps.applicant.fields.roles.options.Professional",
    value: "Professional",
  },
  { label: "newHk.steps.applicant.fields.roles.options.Other", value: "Other" },
];

export const incorporationPurposeKeys = [
  "operateHK",
  "assetMgmt",
  "holdingCo",
  "crossBorder",
...
export const shareCountOptions = [
  { label: "newHk.company.fields.capAmount.options.1", value: "1" },
  { label: "newHk.company.fields.capAmount.options.10", value: "10" },
  { label: "newHk.company.fields.capAmount.options.100", value: "100" },
  { label: "newHk.company.fields.capAmount.options.1000", value: "1000" },
...
export const finYearOptions = [
  {
    label: "newHk.steps.acct.fields.finYrEnd.options.December 31",
    value: "December 31",
  },
  {
    label: "newHk.steps.acct.fields.finYrEnd.options.March 31",
    value: "March 31",
  },
  {
    label: "newHk.steps.acct.fields.finYrEnd.options.June 30",
    value: "June 30",
  },
  {
...
export const bookKeepingCycleOptions = [
  {
    label: "newHk.steps.acct.fields.bookKeepingCycle.options.Monthly",
    value: "Monthly",
  },
  {
    label: "newHk.steps.acct.fields.bookKeepingCycle.options.Quarterly",
    value: "Quarterly",
  },
  {
    label: "newHk.steps.acct.fields.bookKeepingCycle.options.Half-annually",
    value: "Half-annually",
  },
  {
    label: "newHk.steps.acct.fields.bookKeepingCycle.options.Annually",
    value: "Annually",
  },
];
...
export const yesNoOtherOptions = [
  ...
  {
    label: "newHk.steps.acct.fields.xero.options.Recommendation required",
    value: "Recommendation required",
  },
...
export const notifyPaymentSuccess = async (payload: any) => {
  try {
    const res = await api.post(
      "/incorporation/confirm-invoicePayment",
      payload
    );
    return res.data;
  } catch (err) {
...
export const uploadIncorpoPaymentBankProof = async (
  docId: string,
  country: string,
  file: File,
  paymethod: string,
  ...
  const r = await api.post(
    `/incorporation/payment/${docId}/bank-proof`,
    formData,
    {
      headers: { "Content-Type": "multipart/form-data" },
    }
...
export const deleteIncorpoPaymentBankProof = async (
  docId: string,
  country: string
) => {
  const r = await api.delete(`/incorporation/payment/${docId}/bank-proof`, {
    data: { country },
  });
  return r.data;
};
