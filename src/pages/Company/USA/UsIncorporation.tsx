...
function ShareholdersWidget({
    ...
    // console.log("selectedEntity",form.selectedEntity)
        ...
        <div className="w-full">
            ...
            <div className="space-y-4">
                {shareholders.map((sh, idx) => (
                    <Card key={idx} className="pt-4">
                        <CardContent className="grid grid-cols-1 md:grid-cols-5 gap-4">
                            <Label className="font-medium md:col-span-1">
                                {t(
                            ...
                            <Input
                                ...
                                value={sh.email}
                                onChange={(e) =>
                                    updateAt(idx, { email: e.target.value })
                                }
                            />
                            <Label className="font-medium">
                            ...
                            <Input
                                ...
                                value={sh.phone}
                                onChange={(e) =>
                                    updateAt(idx, { phone: e.target.value })
                                }
                            />
                            ...
                            {shareholders.length > 1 && (
                                <button
                                    className="text-destructive hover:opacity-80 justify-self-start"
...
export default function ConfigDrivenUSAForm() {
    ...
    const activeStep =
        hasType(step) && step.type === "sections"
            ? (hydrateDynamicOptions(
                step
            ) as AnyStep)
            : step;
    ...
    const renderSectionsStep = (
        s: Extract<StepDef, { type: "sections" }>
    ) => (
        <>
            <Card>
                <CardContent className="pt-6 space-y-6">
