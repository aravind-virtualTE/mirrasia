            ...
            <Table className="min-w-full w-full table-auto text-xs text-left lg:min-w-[1100px]">
              <TableHeader className="sticky top-0 z-10 bg-background">
                <TableRow className="h-9">
                  ...
                  <TableHead className="px-2 py-1 min-w-[280px] md:min-w-[340px]">
                    <button
                      type="button"
                  ...
                  <TableHead className="px-2 py-1 min-w-[200px]">
                    <button
                      type="button"
                  ...
                  <TableHead className="px-2 py-1 min-w-[200px]">Email</TableHead>
                  <TableHead className="px-2 py-1 min-w-[100px]">Contact</TableHead>
                  <TableHead className="px-2 py-1 min-w-[100px]">Jurisdiction</TableHead>

                  {/* Description: flexible, takes remaining space */}
                  <TableHead className="px-2 py-1 min-w-[200px] w-full">Description</TableHead>

                  <TableHead className="px-2 py-1 w-[110px] whitespace-nowrap">Updated At</TableHead>
