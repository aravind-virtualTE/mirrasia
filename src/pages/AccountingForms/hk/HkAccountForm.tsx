                ...
                <CardContent className="space-y-6">
                    ...
                    {/* <div className="w-full max-w-3xl mx-auto space-y-6 py-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="companyName" type="string" placeholder="Valid Name" className="w-full" required />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="dateOfIncorporation" type="date" placeholder="Valid Name" className="w-full" />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="countryName" type="string" placeholder="Country Names..." className="w-full" required />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="description" type="string" placeholder="description..." className="w-full" required />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="costSale" type="string" placeholder="Valid Name" className="w-full" required />
                        </div>
                        <AccountingForm />
