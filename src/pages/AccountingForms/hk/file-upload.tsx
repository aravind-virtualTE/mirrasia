...
import { accountingServicesAtom, hkAccountFormState } from './hkAccountState';
...
interface FileUploadProps {
  ...
  maxSize?: number;
  accept?: string;
  field: keyof hkAccountFormState['accountInfoData'];
}
...
export function FileUpload({
  ...
  const files = formState.accountInfoData[field] || [];
