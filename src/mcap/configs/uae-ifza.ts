...
const ENTITY_OPTIONS = [
  { label: "uae.options.entityType.localLlc", value: "UAE-LOCAL-LLC" },
  { label: "uae.options.entityType.ifzaFzco", value: "UAE-IFZA-FZCO" },
  { label: "uae.options.entityType.difcFzco", value: "UAE-DIFC-FZCO" },
  { label: "uae.options.entityType.dwtcFzco", value: "UAE-DWTC-FZCO" },
  { label: "uae.options.entityType.dmccFzco", value: "UAE-DMCC-FZCO" },
  { label: "uae.options.entityType.dicFzco", value: "UAE-DIC-FZCO" },
];
...
export const UAE_IFZA_CONFIG: McapConfig = {
  ...
  confirmationDetails: {
    title: "uae.confirmation.title",
    message: "uae.confirmation.message",
    steps: [
      {
        title: "uae.confirmation.steps.initialReview.title",
        description: "uae.confirmation.steps.initialReview.description",
      },
      {
        title: "uae.confirmation.steps.kycVerification.title",
        description: "uae.confirmation.steps.kycVerification.description",
      },
      {
        title: "uae.confirmation.steps.filing.title",
        description: "uae.confirmation.steps.filing.description",
      },
    ],
  },
  steps: [
    {
      ...
      description: "uae.steps.applicant.description",
      fields: [
        {
          type: "info",
          label: "uae.applicant.notice.label",
          content: "uae.applicant.notice.content",
        },
        ...
        { type: "text", name: "applicantPhone", label: "mcap.common.fields.applicantPhone", required: true },
        {
          ...
          label: "uae.applicant.fields.applicantRelationship.label",
          required: true,
          options: [
            { label: "uae.options.applicantRelationship.director", value: "director" },
            { label: "uae.options.applicantRelationship.chiefManager", value: "chief_manager" },
            { label: "uae.options.applicantRelationship.authorizedPerson", value: "authorized_person" },
            { label: "uae.options.applicantRelationship.majorShareholder", value: "major_shareholder" },
            { label: "uae.options.applicantRelationship.expertAdvisor", value: "expert_advisor" },
        ...
        },
        {
          ...
          label: "uae.applicant.fields.applicantRelationshipOther.label",
    ...
    },
    {
      ...
      description: "uae.steps.compliance.description",
      fields: [
        {
          type: "radio-group",
          name: "legalEthicalIssues",
          label: "uae.compliance.legalEthicalIssues.label",
          required: true,
          options: [
            { label: "mcap.common.options.yes", value: "yes" },
            { label: "mcap.common.options.no", value: "no" },
            { label: "mcap.common.options.doNotKnow", value: "unknown" },
            { label: "uae.compliance.options.considerLegalAdvice", value: "legal_advice" },
            { label: "mcap.common.options.other", value: "other" },
          ],
        },
        {
          ...
          label: "uae.compliance.fields.legalEthicalIssuesOther.label",
          condition: (data) => data.legalEthicalIssues === "other",
        },
        {
          type: "radio-group",
          name: "annualRenewalConsent",
          label: "uae.compliance.annualRenewalConsent.label",
          required: true,
          options: [
            { label: "mcap.common.options.yes", value: "yes" },
            { label: "mcap.common.options.no", value: "no" },
            { label: "uae.compliance.options.internalAfterEstablishment", value: "internal" },
        ...
        },
        {
          ...
          label: "uae.compliance.sanctionCountriesOps.label",
          required: true,
        ...
        },
        {
          ...
          label: "uae.compliance.sanctionPersonnelResidency.label",
          required: true,
        ...
        },
        {
          ...
          label: "uae.compliance.crimeaSevastopol.label",
          required: true,
          options: YES_NO_DONT_KNOW_OPTIONS,
        },
        {
          ...
          label: "uae.compliance.sensitiveSectors.label",
          required: true,
          options: YES_NO_OPTIONS,
        },
      ],
    },
    {
      ...
      description: "uae.steps.company.description",
      ...
      fields: [
        ...
        // --- Company Business Details ---
        {
          type: "checkbox-group",
          name: "businessTypes",
          label: "uae.company.fields.businessTypes.label",
          required: true,
          colSpan: 2,
          options: [
            { label: "uae.options.businessType.crypto", value: "crypto" },
            { label: "uae.options.businessType.itBlockchain", value: "it_blockchain" },
            { label: "uae.options.businessType.cryptoInvestment", value: "crypto_investment" },
            { label: "uae.options.businessType.cryptoGames", value: "crypto_games" },
            { label: "uae.options.businessType.forexTrading", value: "fx_trading" },
            { label: "uae.options.businessType.finance", value: "finance" },
            { label: "uae.options.businessType.trading", value: "trading" },
            { label: "uae.options.businessType.distribution", value: "distribution" },
            { label: "uae.options.businessType.consulting", value: "consulting" },
            { label: "uae.options.businessType.manufacturing", value: "manufacturing" },
            { label: "uae.options.businessType.ecommerce", value: "ecommerce" },
            { label: "uae.options.businessType.onlineDelivery", value: "online_delivery" },
            { label: "mcap.common.options.other", value: "other" },
          ],
        },
        {
          ...
          label: "uae.company.fields.businessTypesOther.label",
          colSpan: 2,
        ...
        },
        {
          ...
          label: "uae.company.fields.tradeDescription.label",
          required: true,
          colSpan: 2,
        },
        {
          ...
          label: "uae.company.fields.businessSummary.label",
          required: true,
          colSpan: 2,
        },
        {
        ...
        },
        {
          ...
          label: "uae.company.fields.purposeOfEstablishment.label",
          colSpan: 2,
          options: [
            { label: "uae.options.purpose.diversification", value: "diversification" },
            { label: "uae.options.purpose.advisorSuggested", value: "advisor_suggested" },
            { label: "uae.options.purpose.internationalExpansion", value: "international_expansion" },
            { label: "uae.options.purpose.assetManagement", value: "asset_management" },
            { label: "uae.options.purpose.holdingCompany", value: "holding_company" },
            { label: "uae.options.purpose.competitiveAdvantage", value: "competitive_advantage" },
            { label: "uae.options.purpose.lowTax", value: "low_tax" },
            { label: "mcap.common.options.other", value: "other" },
          ],
        },
        {
        ...
        },
        {
          type: "select",
          name: "paidInCapital",
          label: "uae.company.fields.paidInCapital.label",
          required: true,
          options: [
            { label: "uae.options.paidInCapital.oneAed", value: "1" },
            { label: "uae.options.paidInCapital.hundredAed", value: "100" },
            { label: "uae.options.paidInCapital.tenThousandAed", value: "10000" },
            { label: "mcap.common.options.other", value: "other" },
          ],
        },
        {
          ...
          label: "uae.company.fields.paidInCapitalOther.label",
          condition: (data) => data.paidInCapital === "other",
        },
        {
          type: "radio-group",
          name: "registeredAddressChoice",
          label: "uae.company.fields.registeredAddressChoice.label",
          required: true,
          colSpan: 2,
          options: [
            { label: "uae.options.registeredAddressChoice.mirrAsia", value: "mirasia_address" },
            { label: "uae.options.registeredAddressChoice.own", value: "own_address" },
          ],
        },
        {
          type: "textarea",
          name: "registeredAddress",
          label: "uae.company.fields.registeredAddress.label",
          colSpan: 2,
    ...
    },
    {
      ...
      description: "uae.steps.accounting.description",
      fields: [
        {
          type: "select",
          name: "finYrEnd",
        ...
        },
        {
          type: "radio-group",
          name: "xero",
          label: "uae.accounting.fields.xero.label",
          options: [
            { label: "uae.accounting.options.xero.yesNeedSetup", value: "yes" },
            { label: "uae.accounting.options.xero.noOwnSystem", value: "no" },
            { label: "uae.accounting.options.xero.needAdvice", value: "advice" },
          ],
        },
      ],
    },
